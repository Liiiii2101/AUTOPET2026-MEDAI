...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset226_uni_seg/nnUNetTrainer__nnUNetPlans__3d_fullres_default'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, '/projects/nki-breast-mri/snapshot/a_PETCT/firstDiagnose/beforeSurgery_nnunet/imagesTs_miccai'),
                                 join(nnUNet_raw, '/projects/nki-breast-mri/snapshot/a_PETCT/firstDiagnose/beforeSurgery_nnunet/imagesTs_predlowres_prompt_miccai_nnunet'),
